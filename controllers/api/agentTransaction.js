...
exports.getAllTransactions = async (req, res) => {
    try {
        ...
        const { start, search, draw, length, order, dir, agentCode, startDate, endDate } = req.body;
        ...
        sendError(error, "API | Agent Transaction | Get All",req.originalUrl);
        return res.json({
            status: 0,
...
exports.getTransactionsByAgent = async (req, res) => {
    try {
        ...
        sendError(error, "API | Agent Transaction | Get By Agent",req.originalUrl);
        return res.json({
            status: 0,
            msg: ERR_MSG.INTERNAL_ERROR,
        });
...
exports.getTransactionByType = async (req, res) => {
    try {
        ...
        sendError(error, "API | User Transaction | Get Info",req.originalUrl);
        return res.json({
            status: 0,
            msg: ERR_MSG.INTERNAL_ERROR,
        });
